import{r as p,b as We,a as O}from"./vendor-729d4b68.js";import{u as ge,a as Ye,B as Ve,R as Xe,b as Y,N as J}from"./router-9805300c.js";import{C as le,A as Ce,X as Qe,L as Je,a as Oe,b as Ke,I as Ze,c as te,U as et,d as Ae,S as tt,e as rt,f as ot,M as at,g as _e,P as Ie,h as st,i as nt,H as it,j as lt,Z as ct,k as dt,R as ut,l as gt,m as De,E as Le,n as we,o as pt}from"./icons-47950fa9.js";import{c as mt}from"./store-da2cf27e.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(a){if(a.ep)return;a.ep=!0;const s=o(a);fetch(a.href,s)}})();console.log("🧪 Debug: test-minimal.jsx starting...");try{console.log("🧪 Debug: Testing React import..."),console.log("🧪 Debug: React is available")}catch(e){console.log("❌ Debug: React import failed:",e)}try{console.log("🧪 Debug: Testing DOM manipulation...");const e=document.getElementById("root");e?(e.innerHTML='<div style="padding: 20px; color: green;">✅ Minimal React test loaded!</div>',console.log("✅ Debug: DOM manipulation successful")):console.log("❌ Debug: Root element not found")}catch(e){console.log("❌ Debug: DOM manipulation failed:",e)}console.log("🧪 Debug: test-minimal.jsx completed");var ze={exports:{}},pe={};/**
 * @license React
