import{r as p,a as O}from"./vendor-729d4b68.js";import{u as ge,a as Ge,B as qe,R as We,b as Y,N as J}from"./router-9805300c.js";import{C as le,A as Se,X as Ye,L as Ve,a as Pe,b as Xe,I as Qe,c as te,U as Je,d as Re,S as Ze,e as Ke,f as et,M as tt,g as Oe,P as Ae,h as rt,i as ot,H as at,j as st,Z as nt,k as it,R as lt,l as ct,m as _e,E as Ie,n as we,o as dt}from"./icons-47950fa9.js";import{c as ut}from"./store-da2cf27e.js";var Le={exports:{}},pe={};/**
 * @license React
...
`;if(typeof document<"u"&&!document.getElementById("button-styles")){const e=document.createElement("style");e.id="button-styles",e.textContent=Tt,document.head.appendChild(e)}const Ne=({type:e="info",title:r,message:o,onDismiss:n,dismissible:a=!1,icon:s,className:i="",children:l})=>{const d={success:{icon:le,bgColor:"bg-green-50",borderColor:"border-green-200",iconColor:"text-green-500",textColor:"text-green-800",titleColor:"text-green-900"},error:{icon:Se,bgColor:"bg-red-50",borderColor:"border-red-200",iconColor:"text-red-500",textColor:"text-red-800",titleColor:"text-red-900"},warning:{icon:Xe,bgColor:"bg-yellow-50",borderColor:"border-yellow-200",iconColor:"text-yellow-500",textColor:"text-yellow-800",titleColor:"text-yellow-900"},info:{icon:Qe,bgColor:"bg-blue-50",borderColor:"border-blue-200",iconColor:"text-blue-500",textColor:"text-blue-800",titleColor:"text-blue-900"}},c=d[e]||d.info,h=s||c.icon,g=["flex","items-start","gap-3","p-4","rounded-lg","border",c.bgColor,c.borderColor,i].join(" ");return t.jsxs("div",{className:g,role:"alert",children:[t.jsx("div",{className:"flex-shrink-0",children:t.jsx(h,{size:20,className:c.iconColor,"aria-hidden":"true"})}),t.jsxs("div",{className:"flex-1 min-w-0",children:[r&&t.jsx("h3",{className:`text-sm font-medium ${c.titleColor} mb-1`,children:r}),o&&t.jsx("p",{className:`text-sm ${c.textColor}`,children:o}),l&&t.jsx("div",{className:`text-sm ${c.textColor} mt-1`,children:l})]}),a&&n&&t.jsx("button",{type:"button",className:`
            ...
            transition-colors
            duration-200
          `,onClick:n,"aria-label":"Dismiss message",children:t.jsx(Pe,{size:16})})]})},Pt=`
  /* Background colors */
...
`;if(typeof document<"u"&&!document.getElementById("header-styles")){const e=document.createElement("style");e.id="header-styles",e.textContent=zt,document.head.appendChild(e)}const Mt=()=>{const e=ge(),[r,o]=p.useState(!1),[n,a]=p.useState(""),{isAuthenticated:s,cleaner:i,properties:l,addProperty:d,updatePropertyLastUsed:c,setCurrentProperty:h,getPhotoCount:g}=$();p.useEffect(()=>{s||e("/login",{replace:!0})},[s,e]);const m=[...l.filter(u=>u.name.toLowerCase().includes(n.toLowerCase())||u.address.toLowerCase().includes(n.toLowerCase()))].sort((u,y)=>{const x=new Date(u.lastUsed||u.createdAt).getTime();return new Date(y.lastUsed||y.createdAt).getTime()-x}),b=u=>{h(u),c(u.id),e(`/capture/${u.id}`)},f=u=>{const y=d(u);o(!1),b(y)};return s?t.jsxs(fe,{children:[t.jsx(ue,{title:"Select Property",subtitle:`Welcome back, ${i==null?void 0:i.name}`}),t.jsxs(oe,{className:"flex-1",children:[t.jsxs("div",{className:"py-4 space-y-4",children:[t.jsxs("div",{className:"relative",children:[t.jsx("div",{className:"absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none",children:t.jsx(Oe,{size:20,className:"text-gray-400"})}),t.jsx("input",{type:"text",placeholder:"Search properties...",value:n,onChange:u=>a(u.target.value),className:"block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"})]}),t.jsx(A,{variant:"outline",size:"medium",icon:Ae,onClick:()=>o(!0),fullWidth:!0,children:"Add New Property"})]}),t.jsx("div",{className:"space-y-4 pb-6",children:m.length===0?t.jsx($t,{hasSearch:n.length>0,onAddProperty:()=>o(!0)}):m.map(u=>t.jsx(Ut,{property:u,photoCount:g(u.id),onSelect:()=>b(u)},u.id))})]}),r&&t.jsx(Bt,{onAdd:f,onCancel:()=>o(!1)})]}):null},Ut=({property:e,photoCount:r,onSelect:o})=>{const n=new Date(e.lastUsed||e.createdAt),a=Date.now()-n.getTime()<24*60*60*1e3;return t.jsxs("div",{className:"bg-white rounded-lg border border-gray-200 p-4 cursor-pointer hover:border-primary hover:shadow-md transition-all",onClick:o,children:[t.jsxs("div",{className:"flex items-start justify-between",children:[t.jsxs("div",{className:"flex-1 min-w-0",children:[t.jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-1",children:e.name||"Unnamed Property"}),t.jsxs("div",{className:"flex items-center text-gray-600 mb-3",children:[t.jsx(rt,{size:16,className:"mr-2 flex-shrink-0"}),t.jsx("span",{className:"text-sm truncate",children:e.address})]}),t.jsxs("div",{className:"flex items-center justify-between text-xs text-gray-500",children:[t.jsxs("div",{className:"flex items-center",children:[t.jsx(ot,{size:14,className:"mr-1"}),t.jsx("span",{children:a?"Today":n.toLocaleDateString()})]}),r.total>0&&t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsxs("span",{children:[r.total," photos"]}),t.jsx("span",{children:"•"}),t.jsxs("span",{children:[r.complete," rooms complete"]})]})]})]}),t.jsx("div",{className:"ml-3 flex-shrink-0",children:t.jsx(Re,{size:20,className:"text-gray-400"})})]}),r.rooms>0&&t.jsxs("div",{className:"mt-3 pt-3 border-t border-gray-100",children:[t.jsxs("div",{className:"flex items-center justify-between text-xs text-gray-600 mb-1",children:[t.jsx("span",{children:"Progress"}),t.jsxs("span",{children:[Math.round(r.complete/r.rooms*100),"%"]})]}),t.jsx("div",{className:"w-full bg-gray-200 rounded-full h-2",children:t.jsx("div",{className:"bg-primary h-2 rounded-full transition-all duration-300",style:{width:`${Math.round(r.complete/r.rooms*100)}%`}})})]})]})},$t=({hasSearch:e,onAddProperty:r})=>e?t.jsxs("div",{className:"text-center py-12",children:[t.jsx(Oe,{size:48,className:"mx-auto text-gray-400 mb-4"}),t.jsx("h3",{className:"text-lg font-medium text-gray-900 mb-2",children:"No properties found"}),t.jsx("p",{className:"text-gray-500 mb-6",children:"Try adjusting your search terms"})]}):t.jsxs("div",{className:"text-center py-12",children:[t.jsx("div",{className:"w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-4",children:t.jsx(at,{size:32,className:"text-gray-400"})}),t.jsx("h3",{className:"text-lg font-medium text-gray-900 mb-2",children:"No properties yet"}),t.jsx("p",{className:"text-gray-500 mb-6",children:"Add your first property to start documenting your cleaning work"}),t.jsx(A,{variant:"primary",icon:Ae,onClick:r,children:"Add Your First Property"})]}),Bt=({onAdd:e,onCancel:r})=>{const[o,n]=p.useState({name:"",address:"",notes:""}),[a,s]=p.useState({}),[i,l]=p.useState(!1),d=(g,j)=>{n(m=>({...m,[g]:j})),a[g]&&s(m=>({...m,[g]:""}))},c=()=>{const g={};return o.name.trim()?o.name.length<F.PROPERTY_NAME.MIN_LENGTH?g.name=`Name must be at least ${F.PROPERTY_NAME.MIN_LENGTH} characters`:o.name.length>F.PROPERTY_NAME.MAX_LENGTH&&(g.name=`Name must be no more than ${F.PROPERTY_NAME.MAX_LENGTH} characters`):g.name="Property name is required",o.address.trim()?o.address.length<F.PROPERTY_ADDRESS.MIN_LENGTH?g.address=`Address must be at least ${F.PROPERTY_ADDRESS.MIN_LENGTH} characters`:o.address.length>F.PROPERTY_ADDRESS.MAX_LENGTH&&(g.address=`Address must be no more than ${F.PROPERTY_ADDRESS.MAX_LENGTH} characters`):g.address="Address is required",s(g),Object.keys(g).length===0},h=async g=>{if(g.preventDefault(),!!c()){l(!0);try{e({name:o.name.trim(),address:o.address.trim(),notes:o.notes.trim()}),k.success("Property added successfully!")}catch(j){console.error("Failed to add property:",j),k.error("Failed to add property. Please try again.")}finally{l(!1)}}};return t.jsx("div",{className:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50",children:t.jsx("div",{className:"bg-white rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto",children:t.jsxs("div",{className:"p-6",children:[t.jsx("h2",{className:"text-xl font-semibold text-gray-900 mb-4",children:"Add New Property"}),t.jsxs("form",{onSubmit:h,className:"space-y-4",children:[t.jsxs("div",{children:[t.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"Property name *"}),t.jsx("input",{type:"text",value:o.name,onChange:g=>d("name",g.target.value),placeholder:"e.g., Main Street Apartment",className:`
...
`;if(typeof document<"u"&&!document.getElementById("camera-view-styles")){const e=document.createElement("style");e.id="camera-view-styles",e.textContent=qt,document.head.appendChild(e)}const Wt=({selectedRoom:e,onRoomSelect:r,roomStatuses:o={},className:n=""})=>t.jsx("div",{className:`flex gap-2 overflow-x-auto pb-2 ${n}`,children:It.slice(0,6).map(a=>{const s=o[a.id]||{},i=e===a.id,l=s.isComplete;return t.jsxs(A,{variant:i?"primary":"ghost",size:"small",onClick:()=>r(a.id),className:`
              flex-shrink-0 relative min-w-[80px] h-16 flex-col gap-1
              ${l?"border-green-500":""}
            `,children:[t.jsx("span",{className:"text-lg",children:a.icon}),t.jsx("span",{className:"text-xs",children:a.label.split(" ")[0]}),l&&t.jsx("div",{className:"absolute -top-1 -right-1 w-4 h-4 bg-green-500 rounded-full flex items-center justify-center",children:t.jsx(ct,{size:10,className:"text-white"})})]},a.id)})}),Yt=`
  /* Grid layout */
  .grid { display: grid; }
...
`;if(typeof document<"u"&&!document.getElementById("room-selector-styles")){const e=document.createElement("style");e.id="room-selector-styles",e.textContent=Yt,document.head.appendChild(e)}const Vt=({currentMode:e="before",onModeChange:r,roomStatus:o={},disabled:n=!1,layout:a="toggle",className:s=""})=>{const{hasBefore:i=!1,hasAfter:l=!1}=o,d=[{id:"before",label:"Before",icon:te,description:"Take a photo of the current state",color:"blue",isComplete:i},{id:"after",label:"After",icon:_e,description:"Take a photo after cleaning",color:"green",isComplete:l}];return a==="toggle"?t.jsx(Xt,{currentMode:e,onModeChange:r,modes:d,disabled:n,className:s}):a==="buttons"?t.jsx(Qt,{currentMode:e,onModeChange:r,modes:d,disabled:n,className:s}):a==="tabs"?t.jsx(Jt,{currentMode:e,onModeChange:r,modes:d,disabled:n,className:s}):null},Xt=({currentMode:e,onModeChange:r,modes:o,disabled:n,className:a})=>{const s=["inline-flex","bg-gray-100","rounded-lg","p-1","gap-1",a].join(" ");return t.jsx("div",{className:s,children:o.map(i=>{const l=e===i.id,d=i.icon;return t.jsxs("button",{onClick:()=>r(i.id),disabled:n,className:`
            ...
            `,children:[i.label,i.isComplete&&t.jsx("div",{className:"absolute -top-1 -right-1 w-4 h-4 bg-green-500 rounded-full flex items-center justify-center",children:t.jsx(_e,{size:10,className:"text-white"})})]},i.id)})})},Jt=({currentMode:e,onModeChange:r,modes:o,disabled:n,className:a})=>{const s=["border-b","border-gray-200",a].join(" ");return t.jsx("div",{className:s,children:t.jsx("nav",{className:"flex space-x-8",children:o.map(i=>{const l=e===i.id,d=i.icon;return t.jsxs("button",{onClick:()=>r(i.id),disabled:n,className:`
                ...
                ${n?"opacity-50 cursor-not-allowed":"cursor-pointer"}
              `,children:[t.jsx(d,{size:16,className:i.isComplete?`text-${i.color}-500`:""}),t.jsx("span",{children:i.label}),i.isComplete&&t.jsx("div",{className:"ml-1 w-2 h-2 bg-green-500 rounded-full"})]},i.id)})})})},Zt=`
  /* Layout */
  .inline-flex { display: inline-flex; }
  .flex { display: flex; }
  .items-center { align-items: center; }
...
`;if(typeof document<"u"&&!document.getElementById("mode-selector-styles")){const e=document.createElement("style");e.id="mode-selector-styles",e.textContent=Zt,document.head.appendChild(e)}const Kt=(e,r=Q.QUALITY,o=Q.FORMAT)=>e.toDataURL(o,r),er=async(e,r={})=>{const{maxWidth:o=Q.MAX_WIDTH,maxHeight:n=Q.MAX_HEIGHT,quality:a=Q.QUALITY,format:s=Q.FORMAT}=r;return new Promise((i,l)=>{try{const d=document.createElement("canvas"),c=d.getContext("2d"),h=e.videoWidth,g=e.videoHeight,{width:j,height:m}=tr(h,g,o,n);d.width=j,d.height=m,c.drawImage(e,0,0,j,m);const b=Kt(d,a,s);i(b)}catch(d){l(new Error(`Image capture failed: ${d.message}`))}})},tr=(e,r,o,n)=>{let{width:a,height:s}={width:e,height:r};if(a<=o&&s<=n)return{width:a,height:s};const i=a/s;return a>s?(a=Math.min(a,o),s=a/i,s>n&&(s=n,a=s*i)):(s=Math.min(s,n),a=s*i,a>o&&(a=o,s=a/i)),{width:Math.round(a),height:Math.round(s)}},Fe=e=>{try{const o=e.split(",")[1].length;return Math.round(o*.75)}catch(r){return console.warn("Failed to estimate image size:",r),0}},rr=e=>{if(e===0)return"0 B";const r=1024,o=["B","KB","MB","GB"],n=Math.floor(Math.log(e)/Math.log(r));return`${parseFloat((e/Math.pow(r,n)).toFixed(1))} ${o[n]}`},or=e=>{try{return typeof e=="string"&&e.startsWith("data:image/")}catch{return!1}},ar=e=>{try{const r={format:"unknown",size:Fe(e),timestamp:new Date().toISOString(),isValid:or(e)},o=e.match(/data:image\/([^;]+)/);return o&&(r.format=o[1]),r}catch(r){return console.warn("Failed to extract image metadata:",r),{format:"unknown",size:0,timestamp:new Date().toISOString(),isValid:!1}}},sr=e=>{try{const r=e.split(","),o=r[0].match(/:(.*?);/)[1],n=atob(r[1]);let a=n.length;const s=new Uint8Array(a);for(;a--;)s[a]=n.charCodeAt(a);return new Blob([s],{type:o})}catch(r){throw new Error(`Failed to convert data URL to blob: ${r.message}`)}},nr=(e,r,o="jpg")=>{const n=new Date().toISOString().replace(/[:.]/g,"-");return`${e}_${r}_${n}.${o}`},ir=({photos:e={},onPhotoClick:r,onPhotoDelete:o,showControls:n=!0,maxPhotos:a=20,className:s=""})=>{const l=Object.entries(e).flatMap(([c,h])=>{const g=[];return h.before&&g.push({id:`${c}_before`,roomId:c,type:"before",dataURL:h.before,timestamp:h.beforeTimestamp,room:c}),h.after&&g.push({id:`${c}_after`,roomId:c,type:"after",dataURL:h.after,timestamp:h.afterTimestamp,room:c}),g}).sort((c,h)=>new Date(h.timestamp||0)-new Date(c.timestamp||0)).slice(0,a),d=["grid","grid-cols-2","gap-3","p-4",s].join(" ");return l.length===0?t.jsxs("div",{className:"flex flex-col items-center justify-center py-12 text-center",children:[t.jsx("div",{className:"w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center mb-4",children:t.jsx(Ie,{size:24,className:"text-gray-400"})}),t.jsx("h3",{className:"text-lg font-medium text-gray-900 mb-2",children:"No photos yet"}),t.jsx("p",{className:"text-sm text-gray-500",children:"Start taking before and after photos to see them here"})]}):t.jsx("div",{className:d,children:l.map(c=>t.jsx(lr,{photo:c,onPhotoClick:r,onPhotoDelete:o,showControls:n},c.id))})},lr=({photo:e,onPhotoClick:r,onPhotoDelete:o,showControls:n})=>{const a=()=>{r==null||r(e)},s=d=>{d.stopPropagation(),o==null||o(e)},i=Fe(e.dataURL),l=rr(i);return t.jsxs("div",{className:"relative aspect-square bg-gray-100 rounded-lg overflow-hidden cursor-pointer group hover:shadow-md transition-shadow",onClick:a,children:[t.jsx("img",{src:e.dataURL,alt:`${e.room} ${e.type}`,className:"w-full h-full object-cover",loading:"lazy"}),t.jsx("div",{className:`absolute top-2 left-2 px-2 py-1 rounded text-xs font-medium text-white ${e.type==="before"?"bg-blue-500":"bg-green-500"}`,children:e.type==="before"?"Before":"After"}),t.jsxs("div",{className:"absolute bottom-0 left-0 right-0 bg-black bg-opacity-60 text-white p-2",children:[t.jsx("p",{className:"text-sm font-medium capitalize",children:e.room.replace("-"," ")}),t.jsxs("p",{className:"text-xs opacity-80",children:[l," • ",new Date(e.timestamp).toLocaleTimeString()]})]}),n&&t.jsx("div",{className:"absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-all duration-200 flex items-center justify-center opacity-0 group-hover:opacity-100",children:t.jsxs("div",{className:"flex gap-2",children:[t.jsx(A,{variant:"ghost",size:"small",icon:Ie,onClick:a,className:"bg-white bg-opacity-90 text-gray-900 hover:bg-white","aria-label":"View photo"}),o&&t.jsx(A,{variant:"ghost",size:"small",icon:Pe,onClick:s,className:"bg-red-500 bg-opacity-90 text-white hover:bg-red-600","aria-label":"Delete photo"})]})})]})},cr=`
  /* Grid layout */
  .grid { display: grid; }
  .grid-cols-2 { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .gap-3 { gap: var(--spacing-3); }
